...
| 部品名           | 詳細                              | 数量             | 型番              |
|------------------|-----------------------------------|------------------|-------------------|
| **抵抗**         | R1: 3216 1000Ω                   | 1個              | WR12X102 JTL      |
|                  | R2: 2012 1000Ω                   | 1個              | WR08X102 JTL      |
|                  | R3: 1608 1000Ω                   | 1個              | WR06X102 JTL      |
|                  | R4: 1005 2200Ω                   | 1個              | WR04X222 JTL      |
|                  | R5: 0603 1000Ω（予備1個）        | 1個 + 予備1個    | WR02X102 JAL      |
| **LED**          | D1: 3216 赤                       | 1個              | LTST-C150KRKT     |
|                  | D2: 2012 橙                       | 1個              | OSO50805C1C       |
|                  | D3: 1608 黄                       | 1個              | OSYL1608          |
|                  | D4: 1005 緑                       | 1個              | OSG50402C1C       |
|                  | D5: 0603 青（予備1個）            | 1個 + 予備1個    | OSB50201C1E       |
