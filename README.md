...
|                  | R3: 1608 1000Ω                   | 1個              |
|                  | R4: 1005 2200Ω                   | 1個              |
|                  | R5: 0603 1000Ω（予備1個）        | 1個 + 予備1個    |
| **LED**          | D1: 3216 赤                       | 1個              |
|                  | D2: 2012 橙                       | 1個              |
|                  | D3: 1608 黄                       | 1個              |
|                  | D4: 1005 緑                       | 1個              |
|                  | D5: 0603 青（予備1個）            | 1個 + 予備1個    |
| **コンデンサ**   | C1: 1608 0.1µF                    | 1個              |
| **マイコン**     | U1: ATtiny13A 8SOIC               | 1個              |
| **スイッチ**     | SW1: SSSS811101 または CUS-12TB   | 1個              |
| **電池ホルダ**   | B1: BK-913（スルーホール）        | 1個              |
| **電池**         | CR2032                            | 1個              |
| **バッジ金具**   | 貴和製作所 ウラピンNo.101         | 1個              |
| **基板**         | LBC-3202（直径32mm、FR4）         | 1個              |
...
8. **裏面実装**: 電池ホルダ（B1）とウラピンNo.101を向きに注意してはんだ付け。ウラピンはピンを開き、基板裏面を上にして針を右側、止め金具を左側にセット！
